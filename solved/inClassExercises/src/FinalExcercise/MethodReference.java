...
public class MethodReference {
	/*
	 * A. (Employee e) -> e.getName() B. (Employee e,String s) -> e.setName(s) C.
	 * (String s1,String s2) -> s1.compareTo(s2) D. (Integer x,Integer y) ->
	 * Math.pow(x,y) E. (Apple a) -> a.getWeight() F. (String x) ->
	 * Integer.parseInt(x); G. EmployeeNameComparator comp = new
	 * EmployeeNameComparator(); (Employee e1, Employee e2) -> comp.compare(e1,e2)
	 */
	...
	NameComparator compare = new NameComparator();
	...
	public void evaluator() {
		...
		System.out
				.println("comp.compare(\"Lukman\",\"LukmanA\"):" + new CompareToString().compare("Lukman", "LukmanA"));
		...
		System.out.println(
				"compEmployess.compare(testEmp, testEmp2):" + new CompareEmployee().compare(testEmp, testEmp2));
