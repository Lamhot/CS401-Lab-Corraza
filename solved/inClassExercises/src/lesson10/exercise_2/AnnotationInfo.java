...
public class AnnotationInfo {
	public static void main(String[] args) {
		...
		Class<StillMoreBadCode> stillMoreCodeClass = StillMoreBadCode.class;
		if (stillMoreCodeClass .isAnnotationPresent(BugReport.class)) {			 
			BugReport annotation = (BugReport)stillMoreCodeClass.getAnnotation(BugReport.class);			 
			System.out.printf("%nAssigned To : %s ", annotation.assignedTo());
			System.out.printf("%nSeverity : %d ", annotation.severity());
		}
